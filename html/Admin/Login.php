...
data-open="click" data-menu="horizontal-menu" data-col="1-column">
            ...
            <div class="col-md-4 col-10 box-shadow-2 p-0">
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                  <div class="card-body">
                    <?php 
                      ...
                      if ($error_id != 0 && array_key_exists(1,$errors)) {
                    ?>
                      <div class="alert alert-danger" role="alert">
                        <?php echo $errors[$error_id]; ?>
                      </div>
                    <?php } ?>
                    <form class="form-horizontal form-simple admin_form" action="<?php echo base_url ?>Verify.php" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-6 col-12 text-center text-md-right"><a href="recover-password1.html" class="card-link">Forgot Password?</a></div>
                      </div>
                ...
                <div class="card-footer">
                  <div class="">
                    <p class="float-sm-left text-center m-0"><a href="recover-password1.html" class="card-link">Recover password</a></p>
                    <p class="float-sm-right text-center m-0">New to Translab? <a href="register-simple1.html" class="card-link">Sign Up</a></p>
                  </div>
                </div>
              </div>
            </div>
  ...
  (function() {
    ...
    window.addEventListener('load', function() {
      ...
      var forms = document.getElementsByClassName('admin_form');
