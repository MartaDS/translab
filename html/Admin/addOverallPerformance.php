            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="basic-layout-form-center">Overall Performance Chart</h4>
                ...
                <div class="card-content collapse show">
                  <div class="card-body">                   
                    <form class="form" method="post" action = "<?php echo base_url;?>Functions.php?action=overall_performance_add">
                      <div class="row justify-content-md-center">
                        <div class="col-md-6">
                          <div class="form-body">
                            <div class="form-group">
                              <label for="eventInput1">Title</label>
                              <input type="text" id="eventInput1" class="form-control" placeholder="Title" name="title" required>
                            </div>
                            <div class="form-group">
                              <label for="eventInput2">Value</label>
                              <input type="text" id="eventInput2" class="form-control" placeholder="Value" name="value" required>
                            </div>                            
                            <div class="form-group">
		                        <label>Date</label>
