        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index.html">
              <img class="admin-brand-logo" alt="modern admin logo" src="../../app-assets/images/logo/logo.png">
              <h3 class="brand-text">TransLab</h3>
            </a>
          </li>
    ...
    <div class="navbar-container main-menu-content container center-layout" data-menu="menu-container">
      <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
        <li class="dropdown nav-item" data-menu="dropdown">
          <a class="dropdown-toggle nav-link" href="index.html" data-toggle="dropdown"><i class="la la-line-chart"></i>
            <span>Charts</span>
          </a>
          <ul class="dropdown-menu">
            <li data-menu=""><a class="dropdown-item" href="<?php echo base_url?>Timeline.php" data-toggle="dropdown"><i class="la la-bar-chart"></i> Timeline</a>
            </li>
            <li data-menu=""><a class="dropdown-item" href="<?php echo base_url?>Performance.php" data-toggle="dropdown"><i class="la la-bar-chart"></i> Performance</a>
            </li>
            <li data-menu=""><a class="dropdown-item" href="<?php echo base_url?>OverallPerformance.php" data-toggle="dropdown"><i class="la la-pie-chart"></i> Overall Performance</a>
            </li>
            <li data-menu=""><a class="dropdown-item" href="<?php echo base_url?>addTimeline.php" data-toggle="dropdown"><i class="la la-plus-square"></i> Add Timeline</a>
            </li>
            <li data-menu=""><a class="dropdown-item" href="<?php echo base_url?>addPerformance.php" data-toggle="dropdown"><i class="la la-plus-square"></i> Add Performance</a>
            </li>
            <li data-menu=""><a class="dropdown-item" href="<?php echo base_url?>addOverallPerformance.php" data-toggle="dropdown"><i class="la la-plus-square"></i> Add Overall Performance</a>
            </li>
          </ul>
        </li>
      </ul>
